...
```
wget -N https://raw.githubusercontents.com/Ivy-2501/XrayR-script/main/install.sh && bash install.sh
```
...
[![Stargazers over time](https://starchart.cc/Ivy-2501/XrayR.svg)](https://starchart.cc/Ivy-2501/XrayR)
